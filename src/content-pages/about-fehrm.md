...
The FEHRM unites efforts and delivers common capabilities that enable the Department of Defense (DOD), Department of Veterans Affairs (VA), Department of Homeland Security’s U.S. Coast Guard (USCG) and other federal agencies to deploy the federal EHR. As of today, there are more than 160,000 DOD, VA and USCG federal EHR users—such as doctors and nurses—at 112 parent military treatment facilities, five VA medical centers and 109 USCG sites. More than 6.6 million unique patients are in the federal EHR system. 
