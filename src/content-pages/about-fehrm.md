...
The FEHRM unites efforts and delivers common capabilities that enable the Department of War (DOW), Department of Veterans Affairs (VA), Department of Homeland Security’s U.S. Coast Guard (USCG), Department of Commerce's National Oceanic and Atmospheric Administration (NOAA) and other federal agencies to deploy the Federal EHR. As of today, there are more than 216,000 DOW, VA, USCG, and NOAA Federal EHR users, including doctors, nurses, and other healthcare providers, at 138 parent military treatment facilities, 10 VA medical centers, 110 USCG sites, and seven NOAA sites. More than 8.7 million unique patients are currently in the Federal EHR system.
