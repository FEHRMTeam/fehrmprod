...
The FEHRM unites efforts and delivers common capabilities that enable the Department of Defense (DOD), Department of Veterans Affairs (VA), Department of Homeland Security’s U.S. Coast Guard (USCG), Department of Commerce's National Oceanic and Atmospheric Administration (NOAA) and other federal agencies to deploy the federal EHR. As of today, there are more than 194,000 DOD, VA, USCG and NOAA federal EHR users—such as doctors and nurses—at 135 parent military treatment facilities, five VA medical centers, 109 USCG sites and seven NOAA sites. More than 9.5 million unique patients are in the federal EHR system.
