...
The FEHRM unites efforts and delivers common capabilities that enable the Department of War (DoW), Department of Veterans Affairs (VA), Department of Homeland Security’s U.S. Coast Guard (USCG), Department of Commerce's National Oceanic and Atmospheric Administration (NOAA) and other federal agencies to deploy the Federal EHR. As of today, there are more than 207,000 DoW, VA, USCG, and NOAA Federal EHR users—such as doctors and nurses—at 138 parent military treatment facilities, six VA medical centers, 110 USCG sites and seven NOAA sites. More than 8.5 million unique patients are in the Federal EHR system.
