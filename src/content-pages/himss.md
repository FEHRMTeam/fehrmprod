...
A fireside chat on how VA is using secure interoperability, ambient AI scribing, and immersive technology to modernize the Veteran experience. By taking advantage of new technology, VA is reducing documentation friction and supporting more connected, seamless care across settings.  
...
#### Exhibition Hall | Kiosk #12

Learn more about the FEHRM's collaborative mission with its partners to implement a single, common Federal
Electronic Health Record (EHR) that enhances patient care and provider effectiveness.
...
For more information, visit the [HIMSS26 website](https://www.himssconference.com/).
